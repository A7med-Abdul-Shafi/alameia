...
function TableBatawy2() {
      ...
      formatter: (listofdatabase, value, row) => {
        return (
          <div
            ...
            onClick={() => navigate(`/dashboard/singlebatawy2/${value.id}`)}
          >
            <svg
  ...
  const { data, isLoading, isError, refetch } = useQuery(
    ["batawy2"],
    async () => {
      return await axios.get(`${api}/batawy2`).then((res) => res.data);
    }
  );
  if (isError) {
...
export default React.memo(TableBatawy2);
