...
function NewRahmaneya() {
  ...
  useEffect(() => {
    const projects = async () => {
      await axios.get(`${api}/rahmaneya/in_reason`).then((res) => {
  ...
  useEffect(() => {
    const vacantList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/rahmaneya/vacant`).then(async (res) => {
        setVacant(res.data);
        setIsLoading(false);
      });
    };
  ...
  useEffect(() => {
    const filterList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/rahmaneya/filter`).then(async (res) => {
  ...
  useEffect(() => {
    const alameiaRoomList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/rahmaneyarooms/list`).then(async (res) => {
