...
function TableHemyani() {
      ...
      formatter: (listofdatabase, value, row) => {
        return (
          <div
            ...
            onClick={() => navigate(`/dashboard/singlehemyani/${value.id}`)}
          >
            <svg
  ...
  const { data, isLoading, isError, refetch } = useQuery(
    ["hemyani"],
    async () => {
      return await axios.get(`${api}/hemyani`).then((res) => res.data);
    }
  );
  if (isError) {
...
export default React.memo(TableHemyani);
