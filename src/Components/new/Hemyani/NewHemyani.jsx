...
function NewHemyani() {
  ...
  useEffect(() => {
    const projects = async () => {
      await axios.get(`${api}/hemyani/in_reason`).then((res) => {
  ...
  useEffect(() => {
    const vacantList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/hemyani/vacant`).then(async (res) => {
        setVacant(res.data);
        setIsLoading(false);
      });
    };
  ...
  useEffect(() => {
    const filterList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/hemyani/filter`).then(async (res) => {
  ...
  useEffect(() => {
    const alameiaRoomList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/hemyanirooms/list`).then(async (res) => {
