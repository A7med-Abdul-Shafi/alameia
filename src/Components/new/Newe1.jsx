...
function NewEwaaa() {
  ...
  useEffect(() => {
    const projects = async () => {
      await axios.get(`${api}/ewaaa/in_reason`).then((res) => {
  ...
  useEffect(() => {
    ...
    const vacantList = async () => {
      await axios.get(`${api}/ewaaa/vacant`).then(async (res) => {
        setVacant(res.data);
        setIsLoading(false);
      });
    };
  ...
  useEffect(() => {
    ...
    const filterList = async () => {
      await axios.get(`${api}/ewaaa/filter`).then(async (res) => {
  ...
  useEffect(() => {
    ...
    const alameiaRoomList = async () => {
      await axios.get(`${api}/ewaaarooms/list`).then(async (res) => {
  ...
  console.log(inputFilteredRooms);
  return (
    <>
