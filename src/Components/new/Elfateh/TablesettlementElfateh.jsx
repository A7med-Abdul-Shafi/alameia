...
function TableElfateh() {
      ...
      formatter: (listofdatabase, value, row) => {
        return (
          <div
            ...
            onClick={() => navigate(`/dashboard/singleelfateh/${value.id}`)}
          >
            <svg
  ...
  const { data, isLoading, isError, refetch } = useQuery(
    ["elfateh"],
    async () => {
      return await axios.get(`${api}/elfateh`).then((res) => res.data);
    }
  );
  if (isError) {
...
export default React.memo(TableElfateh);
