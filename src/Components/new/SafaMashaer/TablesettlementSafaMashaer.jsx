...
function TableSafaMashaer() {
      ...
      formatter: (listofdatabase, value, row) => {
        return (
          <div
            ...
            onClick={() => navigate(`/dashboard/singlesafa/${value.id}`)}
          >
            <svg
  ...
  const { data, isLoading, isError, refetch } = useQuery(
    ["safamashaer"],
    async () => {
      return await axios.get(`${api}/safamashaer`).then((res) => res.data);
    }
  );
  if (isError) {
...
export default React.memo(TableSafaMashaer);
