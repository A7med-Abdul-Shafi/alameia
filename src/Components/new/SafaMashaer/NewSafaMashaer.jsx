...
function NewSafaMashaer() {
  ...
  useEffect(() => {
    const projects = async () => {
      await axios.get(`${api}/safamashaer/in_reason`).then((res) => {
  ...
  const addResults = async (e) => {
    ...
    setIsLoading(true);
    await axios
      .post(`${api}/safamashaer`, addedData)
      .then((response) => {
        Swal.fire({
          position: "center",
          icon: "success",
  ...
  useEffect(() => {
    const vacantList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/safamashaer/vacant`).then(async (res) => {
        setVacant(res.data);
        setIsLoading(false);
      });
    };
  ...
  useEffect(() => {
    const filterList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/safamashaer/filter`).then(async (res) => {
  ...
  useEffect(() => {
    const alameiaRoomList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/safamashaerrooms/list`).then(async (res) => {
