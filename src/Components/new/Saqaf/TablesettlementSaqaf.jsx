...
function TableSaqaf() {
      ...
      formatter: (listofdatabase, value, row) => {
        return (
          <div
            ...
            onClick={() => navigate(`/dashboard/singlesaqaf/${value.id}`)}
          >
            <svg
  ...
  const { data, isLoading, isError, refetch } = useQuery(
    ["saqaf"],
    async () => {
      return await axios.get(`${api}/saqaf`).then((res) => res.data);
    }
  );
  if (isError) {
...
export default React.memo(TableSaqaf);
