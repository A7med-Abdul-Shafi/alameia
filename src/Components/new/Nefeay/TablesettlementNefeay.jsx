...
function TableNefeay() {
      ...
      formatter: (listofdatabase, value, row) => {
        return (
          <div
            ...
            onClick={() => navigate(`/dashboard/singlenefeay/${value.id}`)}
          >
            <svg
  ...
  const { data, isLoading, isError, refetch } = useQuery(
    ["nefeay"],
    async () => {
      return await axios.get(`${api}/nefeay`).then((res) => res.data);
    }
  );
  if (isError) {
...
export default React.memo(TableNefeay);
