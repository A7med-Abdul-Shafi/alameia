...
function NewSawady1() {
  ...
  useEffect(() => {
    const projects = async () => {
      await axios.get(`${api}/sawady1/in_reason`).then((res) => {
  ...
  useEffect(() => {
    const vacantList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/sawady1/vacant`).then(async (res) => {
        setVacant(res.data);
        setIsLoading(false);
      });
    };
  ...
  useEffect(() => {
    const filterList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/sawady1/filter`).then(async (res) => {
  ...
  useEffect(() => {
    const alameiaRoomList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/sawady1rooms/list`).then(async (res) => {
