...
function TableSawady1() {
      ...
      formatter: (listofdatabase, value, row) => {
        return (
          <div
            ...
            onClick={() => navigate(`/dashboard/singlesawady1/${value.id}`)}
          >
            <svg
  ...
  const { data, isLoading, isError, refetch } = useQuery(
    ["sawady1"],
    async () => {
      return await axios.get(`${api}/sawady1`).then((res) => res.data);
    }
  );
  if (isError) {
...
export default React.memo(TableSawady1);
