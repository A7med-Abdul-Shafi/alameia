...
function TableSawady2() {
      ...
      formatter: (listofdatabase, value, row) => {
        return (
          <div
            ...
            onClick={() => navigate(`/dashboard/singlesawady2/${value.id}`)}
          >
            <svg
  ...
  const { data, isLoading, isError, refetch } = useQuery(
    ["sawady2"],
    async () => {
      return await axios.get(`${api}/sawady2`).then((res) => res.data);
    }
  );
  if (isError) {
...
export default React.memo(TableSawady2);
