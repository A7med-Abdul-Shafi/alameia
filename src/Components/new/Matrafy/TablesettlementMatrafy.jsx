...
function TableMatrafy() {
      ...
      formatter: (listofdatabase, value, row) => {
        return (
          <div
            ...
            onClick={() => navigate(`/dashboard/singlematrafy/${value.id}`)}
          >
            <svg
  ...
  const { data, isLoading, isError, refetch } = useQuery(
    ["matrafy"],
    async () => {
      return await axios.get(`${api}/matrafy`).then((res) => res.data);
    }
  );
  if (isError) {
...
export default React.memo(TableMatrafy);
