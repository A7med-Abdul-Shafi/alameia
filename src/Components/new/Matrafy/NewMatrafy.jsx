...
function NewMatrafy() {
  ...
  useEffect(() => {
    const projects = async () => {
      await axios.get(`${api}/matrafy/in_reason`).then((res) => {
  ...
  useEffect(() => {
    const vacantList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/matrafy/vacant`).then(async (res) => {
        setVacant(res.data);
        setIsLoading(false);
      });
    };
  ...
  useEffect(() => {
    const filterList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/matrafy/filter`).then(async (res) => {
  ...
  useEffect(() => {
    const alameiaRoomList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/matrafyrooms/list`).then(async (res) => {
