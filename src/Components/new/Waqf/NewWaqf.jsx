...
function NewWaqf() {
  ...
  useEffect(() => {
    const projects = async () => {
      await axios.get(`${api}/waqf/in_reason`).then((res) => {
  ...
  useEffect(() => {
    const vacantList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/waqf/vacant`).then(async (res) => {
        setVacant(res.data);
        setIsLoading(false);
      });
    };
  ...
  useEffect(() => {
    const filterList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/waqf/filter`).then(async (res) => {
  ...
  useEffect(() => {
    const alameiaRoomList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/waqfrooms/list`).then(async (res) => {
