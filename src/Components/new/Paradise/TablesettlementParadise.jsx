...
function TableParadise() {
      ...
      formatter: (listofdatabase, value, row) => {
        return (
          <div
            ...
            onClick={() => navigate(`/dashboard/singleparadise/${value.id}`)}
          >
            <svg
  ...
  const { data, isLoading, isError, refetch } = useQuery(
    ["paradise"],
    async () => {
      return await axios.get(`${api}/paradise`).then((res) => res.data);
    }
  );
  if (isError) {
...
export default React.memo(TableParadise);
