...
function TableElsalam() {
      ...
      formatter: (listofdatabase, value, row) => {
        return (
          <div
            ...
            onClick={() => navigate(`/dashboard/singleelsalam/${value.id}`)}
          >
            <svg
  ...
  const { data, isLoading, isError, refetch } = useQuery(
    ["elsalam"],
    async () => {
      return await axios.get(`${api}/elsalam`).then((res) => res.data);
    }
  );
  if (isError) {
...
export default React.memo(TableElsalam);
