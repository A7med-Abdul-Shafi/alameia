...
function NewEwaab() {
  ...
  useEffect(() => {
    const projects = async () => {
      await axios.get(`${api}/ewaab/in_reason`).then((res) => {
  ...
  useEffect(() => {
    const vacantList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/ewaab/vacant`).then(async (res) => {
        setVacant(res.data);
        setIsLoading(false);
      });
    };
  ...
  useEffect(() => {
    ...
    const filterList = async () => {
      await axios.get(`${api}/ewaab/filter`).then(async (res) => {
  ...
  useEffect(() => {
    ...
    const alameiaRoomList = async () => {
      await axios.get(`${api}/ewaabrooms/list`).then(async (res) => {
