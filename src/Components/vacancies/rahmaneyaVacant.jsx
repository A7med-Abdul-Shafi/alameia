...
import RahmaneyaAddRooms from "./RahmaneyaAddRooms";
import RahmaneyaEditRooms from "./RahmaneyaEditRooms";
...
const RahmaneyaVacant = (props) => {
  ...
  useEffect(() => {
    const vacantList = async () => {
      setIsLoading(true);
      await axios.get(`${url}/rahmaneya/vacant`).then(async (res) => {
        setVacant(res.data);
        setIsLoading(false);
      });
    };
  ...
  useEffect(() => {
    const filterList = async () => {
      setLoading(true);
      await axios.get(`${url}/rahmaneya/filter`).then(async (res) => {
  ...
  useEffect(() => {
    const alameiaRoomList = async () => {
      setLoading(true);
      await axios.get(`${url}/rahmanearooms/list`).then(async (res) => {
...
export default RahmaneyaVacant;
