...
import ElfatehAddRooms from "./ElfatehAddRooms";
import ElfatehEditRooms from "./ElfatehEditRooms";
import api from "../../customApi";
function ElfatehVacant(props) {
  ...
  useEffect(() => {
    const vacantList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/elfateh/vacant`).then(async (res) => {
        setVacant(res.data);
        setIsLoading(false);
      });
    };
  ...
  useEffect(() => {
    const filterList = async () => {
      setLoading(true);
      await axios.get(`${api}/elfateh/filter`).then(async (res) => {
  ...
  useEffect(() => {
    const alameiaRoomList = async () => {
      setLoading(true);
      await axios.get(`${api}/elfatehrooms/list`).then(async (res) => {
