...
import ParadiseAddRooms from "./ParadiseAddRooms";
import ParadiseEditRooms from "./ParadiseEditRooms";
...
const ParadiseVacant = (props) => {
  ...
  useEffect(() => {
    const vacantList = async () => {
      setIsLoading(true);
      await axios.get(`${url}/paradise/vacant`).then(async (res) => {
        setVacant(res.data);
        setIsLoading(false);
      });
    };
  ...
  useEffect(() => {
    const filterList = async () => {
      setLoading(true);
      await axios.get(`${url}/paradise/filter`).then(async (res) => {
  ...
  useEffect(() => {
    const alameiaRoomList = async () => {
      setLoading(true);
      await axios.get(`${url}/paradiserooms/list`).then(async (res) => {
