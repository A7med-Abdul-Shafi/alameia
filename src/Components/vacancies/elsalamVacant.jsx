...
import ElsalamAddRooms from "./ElsalamAddRooms";
import ElsalamEditRooms from "./ElsalamEditRooms";
import api from "../../customApi";
function ElsalamVacant(props) {
  ...
  useEffect(() => {
    const vacantList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/elsalam/vacant`).then(async (res) => {
        setVacant(res.data);
        setIsLoading(false);
      });
    };
  ...
  useEffect(() => {
    const filterList = async () => {
      setLoading(true);
      await axios.get(`${api}/elsalam/filter`).then(async (res) => {
  ...
  useEffect(() => {
    const alameiaRoomList = async () => {
      setLoading(true);
      await axios.get(`${api}/elsalamrooms/list`).then(async (res) => {
