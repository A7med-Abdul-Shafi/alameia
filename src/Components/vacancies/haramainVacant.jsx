...
import HaramainAddRooms from "./HaramainAddRooms";
import HaramainEditRooms from "./HaramainEditRooms";
import api from "../../customApi";
function HaramainVacant(props) {
  ...
  useEffect(() => {
    const vacantList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/haramain/vacant`).then(async (res) => {
        setVacant(res.data);
        setIsLoading(false);
      });
    };
  ...
  useEffect(() => {
    const filterList = async () => {
      setLoading(true);
      await axios.get(`${api}/haramain/filter`).then(async (res) => {
  ...
  useEffect(() => {
    const alameiaRoomList = async () => {
      setLoading(true);
      await axios.get(`${api}/haramainrooms/list`).then(async (res) => {
