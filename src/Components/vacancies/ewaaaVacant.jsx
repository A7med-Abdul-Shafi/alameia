...
import EwaaaAddRooms from "./EwaaaAddRooms";
import EwaaaEditRooms from "./EwaaaEditRooms";
import api from "../../customApi";
function EwaaaVacant(props) {
