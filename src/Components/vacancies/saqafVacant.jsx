...
import SaqafAddRooms from "./SaqafAddRooms";
import SaqafEditRooms from "./SaqafEditRooms";
...
const SaqafVacant = (props) => {
  ...
  useEffect(() => {
    const vacantList = async () => {
      setIsLoading(true);
      await axios.get(`${url}/saqaf/vacant`).then(async (res) => {
        setVacant(res.data);
        setIsLoading(false);
      });
    };
  ...
  useEffect(() => {
    const filterList = async () => {
      setLoading(true);
      await axios.get(`${url}/saqaf/filter`).then(async (res) => {
  ...
  useEffect(() => {
    const alameiaRoomList = async () => {
      setLoading(true);
      await axios.get(`${url}/saqafrooms/list`).then(async (res) => {
