...
import Batawy1AddRooms from "./Batawy1AddRooms";
import Batawy1EditRooms from "./Batawy1EditRooms";
import api from "../../customApi";
function Batawy1Vacant(props) {
  ...
  useEffect(() => {
    const vacantList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/batawy1/vacant`).then(async (res) => {
        setVacant(res.data);
        setIsLoading(false);
      });
    };
  ...
  useEffect(() => {
    const filterList = async () => {
      setLoading(true);
      await axios.get(`${api}/batawy1/filter`).then(async (res) => {
  ...
  useEffect(() => {
    const alameiaRoomList = async () => {
      setLoading(true);
      await axios.get(`${api}/batawy1rooms/list`).then(async (res) => {
