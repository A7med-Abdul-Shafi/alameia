...
import Sawady2AddRooms from "./Sawady2AddRooms";
import Sawady2EditRooms from "./Sawady2EditRooms";
...
const Sawady2Vacant = (props) => {
  ...
  useEffect(() => {
    const vacantList = async () => {
      setIsLoading(true);
      await axios.get(`${url}/sawady2/vacant`).then(async (res) => {
        setVacant(res.data);
        setIsLoading(false);
      });
    };
  ...
  useEffect(() => {
    const filterList = async () => {
      setLoading(true);
      await axios.get(`${url}/sawady2/filter`).then(async (res) => {
  ...
  useEffect(() => {
    const alameiaRoomList = async () => {
      setLoading(true);
      await axios.get(`${url}/sawady2rooms/list`).then(async (res) => {
