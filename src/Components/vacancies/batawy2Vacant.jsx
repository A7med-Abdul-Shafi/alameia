...
import Batawy2AddRooms from "./Batawy2AddRooms";
import Batawy2EditRooms from "./Batawy2EditRooms";
import api from "../../customApi";
function Batawy2Vacant(props) {
  ...
  useEffect(() => {
    const vacantList = async () => {
      setIsLoading(true);
      await axios.get(`${api}/batawy2/vacant`).then(async (res) => {
        setVacant(res.data);
        setIsLoading(false);
      });
    };
  ...
  useEffect(() => {
    const filterList = async () => {
      setLoading(true);
      await axios.get(`${api}/batawy2/filter`).then(async (res) => {
  ...
  useEffect(() => {
    const alameiaRoomList = async () => {
      setLoading(true);
      await axios.get(`${api}/batawy2rooms/list`).then(async (res) => {
