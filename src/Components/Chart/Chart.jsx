...
function ChartAlameia({ aspect }) {
  ...
  useEffect(() => {
    const countMasri = async () => {
      await axios.get(`${api}/alameia/egypt`).then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      await axios.get(`${api}/alameia/yaman`).then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios.get(`${api}/alameia/pakistan`).then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios.get(`${api}/alameia/indonesia`).then((response) => {
  ...
  useEffect(() => {
    const countIndi = async () => {
      await axios.get(`${api}/alameia/india`).then((response) => {
  ...
  useEffect(() => {
    const countBangladeshi = async () => {
      await axios.get(`${api}/alameia/bangladesh`).then((response) => {
  ...
  useEffect(() => {
    const countPhilipini = async () => {
      await axios.get(`${api}/alameia/philipin`).then((response) => {
  ...
  return (
    <div className="chart">
      <div className="title">العالمية :</div>
