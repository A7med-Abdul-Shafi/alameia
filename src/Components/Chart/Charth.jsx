...
function ChartHaramain({ aspect }) {
  ...
  useEffect(() => {
    const countMasri = async () => {
      await axios.get(`${api}/haramain/egypt`).then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      await axios.get(`${api}/haramain/yaman`).then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios.get(`${api}/haramain/pakistan`).then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios.get(`${api}/haramain/indonesia`).then((response) => {
  ...
  useEffect(() => {
    const countIndi = async () => {
      await axios.get(`${api}/haramain/india`).then((response) => {
  ...
  useEffect(() => {
    const countBangladeshi = async () => {
      await axios.get(`${api}/haramain/bangladesh`).then((response) => {
  ...
  useEffect(() => {
    const countPhilipini = async () => {
      await axios.get(`${api}/haramain/philipin`).then((response) => {
