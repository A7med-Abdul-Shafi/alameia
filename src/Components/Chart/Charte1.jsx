...
function ChartEwaaa({ aspect }) {
  const [countEgypt, setCountEgypt] = useState([]);
  useEffect(() => {
    const countMasri = async () => {
      await axios.get(`${api}/ewaaa/egypt`).then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      await axios.get(`${api}/ewaaa/yaman`).then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios.get(`${api}/ewaaa/pakistan`).then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios.get(`${api}/ewaaa/indonesia`).then((response) => {
  ...
  useEffect(() => {
    const countIndi = async () => {
      await axios.get(`${api}/ewaaa/india`).then((response) => {
  ...
  useEffect(() => {
    const countBangladeshi = async () => {
      await axios.get(`${api}/ewaaa/bangladesh`).then((response) => {
  ...
  useEffect(() => {
    const countPhilipini = async () => {
      await axios.get(`${api}/ewaaa/philipin`).then((response) => {
  ...
  return (
    <div className="chart">
      <div className="title">إيواء 1 :</div>
