...
const url = api;
const TransportEwaab = () => {
  const [options, setOptions] = useState([]);
  useEffect(() => {
    const projects = async () => {
      await axios.get(`${url}/ewaab/projects`).then((res) => {
  ...
  return (
    <div className="container">
      <h1 style={{ margin: "15px 0px" }}>
        تسجيل الأعداد الإضافية - سكن إيواء 2
      </h1>
