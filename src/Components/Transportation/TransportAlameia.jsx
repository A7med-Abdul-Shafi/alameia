...
const url = api;
const TransportAlameia = () => {
  const [options, setOptions] = useState([]);
  useEffect(() => {
    const projects = async () => {
      await axios.get(`${url}/alameia/projects`).then((res) => {
  ...
  return (
    <div className="container">
      <h1 style={{ margin: "15px 0px" }}>
        تسجيل الأعداد الإضافية - سكن العالمية
      </h1>
...
export default TransportAlameia;
