...
const url = api;
const TransportHaramain = () => {
  const [options, setOptions] = useState([]);
  useEffect(() => {
    const projects = async () => {
      await axios.get(`${url}/haramain/projects`).then((res) => {
  ...
  return (
    <div className="container">
      <h1 style={{ margin: "15px 0px" }}>
        تسجيل الأعداد الإضافية - سكن الحرمين
      </h1>
...
export default TransportHaramain;
