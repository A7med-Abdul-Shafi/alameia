...
const url = api;
const TransportEwaaa = () => {
  const [options, setOptions] = useState([]);
  useEffect(() => {
    const projects = async () => {
      await axios.get(`${url}/ewaaa/projects`).then((res) => {
  ...
  return (
    <div className="container">
      <h1 style={{ margin: "15px 0px" }}>
        تسجيل الأعداد الإضافية - سكن إيواء 1
      </h1>
