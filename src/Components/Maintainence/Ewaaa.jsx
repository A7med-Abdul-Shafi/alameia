...
function EwaaaMaintain() {
  ...
  const { data, refetch } = useQuery(
    ["ewaaaMaintainence"],
    async () => {
      return await axios.get(`${api}/ewaaamaintainence/list`).then((res) => res.data);
    }
  );
  ...
  const handleAddRequest = async () => {
    ...
    await axios
      .post(`${api}/ewaaa/maintainence/new`, addTodo)
      .then(async (res) => {
        refetch();
        setFetchedData([]);
      })
  ...
  const handleDelete = async (id) => {
    ...
    await axios
      .delete(`${api}/ewaaamaintainence/delete/${id}`)
      .then(async (res) => {
