...
function AlameiaMaintain() {
  ...
  const { data, isFetchLoading, isError, refetch } = useQuery(
    ...
    async () => {
      return await axios
        .get(`${api}/alameiamaintainence/list`)
        .then((res) => res.data);
    }
  );
  ...
  const fetchSearchResults = async (event) => {
    ...
    setIsLoading(true);
    await axios
      .get(`${api}/alameia/search?q=${query}`)
      .then(async (res) => {
        setQuery("");
  ...
  const handleAddRequest = async () => {
    ...
    await axios
      .post(`${api}/alameia/maintainence/new`, addTodo)
      .then(async (res) => {
        refetch();
        setFetchedData([]);
      })
  ...
  const handleDelete = async (id) => {
    ...
    await axios
      .delete(`${api}/alameiamaintainence/delete/${id}`)
      .then(async (res) => {
...
export default AlameiaMaintain;
