...
function MaintanenceHaramain() {
  ...
  const { data, refetch } = useQuery(
    ...
    async () => {
      return await axios
        .get(`${api}/haramain/maintainence/list`)
        .then((res) => res.data);
    }
  );
  const addTodo = {
  ...
  const fetchSearchResults = async (event) => {
    ...
    setIsLoading(true);
    await axios
      .get(`${api}/haramain/search?q=${query}`)
      .then(async (res) => {
        setQuery("");
  ...
  const handleAddRequest = async () => {
    ...
    await axios
      .post(`${api}/haramain/maintainence/new`, addTodo)
      .then(async (res) => {
        refetch();
        setFetchedData([]);
      })
  ...
  const handleDelete = async (id) => {
    ...
    await axios
      .delete(`${api}/haramainmaintainence/delete/${id}`)
      .then(async (res) => {
...
export default MaintanenceHaramain;
