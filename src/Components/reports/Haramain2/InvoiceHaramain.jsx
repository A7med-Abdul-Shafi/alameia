...
const countMasri = async () => {
    await axios.get(`${api}/haramain/dues/dayone?value=${project}`).then((response) => {
...
const countYamani = async () => {
    await axios.get(`${api}/haramain/dues/dayone1?value=${project}`).then((response) => {
...
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/indaytwo?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/cleardaytwo?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday3?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday3?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday4?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday4?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday5?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday5?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday6?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday6?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday7?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday7?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday8?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday8?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday9?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday9?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday10?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday10?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday11?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday11?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday12?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday12?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday13?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday13?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday14?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday14?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday15?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday15?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday16?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday16?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday17?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday17?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday18?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday18?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday19?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday19?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday20?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday20?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday21?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday21?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday22?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday22?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday23?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday23?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday24?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday24?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday25?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday25?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday26?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday26?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday27?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday27?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday28?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday28?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday29?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday29?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday30?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/haramain/dues/clearday30?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/inday31?value=${project}`).then((response) => {
...
// useEffect(() => {
//     const countIndonesi = async () => {
//         await axios.get(`${api}/haramain/dues/clearday31?value=${project}`).then((response) => {
...
useEffect(() => {
const countMasri = async () => {
    await axios.get(`${api}/haramain/dues/food/dayone?value=${project}`).then((response) => {
...
useEffect(() => {
const countYamani = async () => {
    await axios.get(`${api}/haramain/dues/food/dayone1?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/indaytwo?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/cleardaytwo?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday3?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday3?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday4?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday4?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday5?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday5?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday6?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday6?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday7?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday7?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday8?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday8?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday9?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday9?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday10?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday10?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday11?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday11?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday12?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday12?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday13?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday13?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday14?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday14?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday15?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday15?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday16?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday16?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday17?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday17?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday18?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday18?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday19?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday19?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday20?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday20?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday21?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday21?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday22?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday22?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday23?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday23?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday24?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday24?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday25?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday25?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday26?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday26?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday27?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday27?value=${project}`)
   .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday28?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday28?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday29?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday29?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday30?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/haramain/dues/food/clearday30?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/haramain/dues/food/inday31?value=${project}`).then((response) => {
...
// useEffect(() => {
//     const countIndonesi = async () => {
//         await axios.get(`${api}/haramain/dues/food/clearday31?value=${project}`).then((response) => {
//             if (monthDays === 30 || monthDays === 28){
...
<div className="new1">
    ...
    <div className="form" style={{ marginBottom: "10px" }}>
        <h1>
        فاتورة سكن الحرمين لشهر {currentMonth} - {new Date().getFullYear()}{" "}
        مشروع:{project}
        </h1>
        <Formik
    ...
    <span style={{ fontSize: "14px" }}>فاتورة كامب الحرمين</span>
    <div>
        <span style={{ color: "teal", fontSize: "15px", alignSelf: "end" }}>
        MONTH FROM : {firstDay} TO {lastDay}
        </span>
        <div style={{ display: "flex", justifyContent: "space-around" }}>
        <a href={`${api}/haramain/invoicereport/api/file?value=${project}`}>
            <svg
        ...
        <ReactToPdf
            targetRef={ref}
            filename="فاتورة كامب الحرمين.pdf"
            scale={0.7}
        >
            {({ toPdf }) => (
            <svg
