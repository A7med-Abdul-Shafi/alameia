...
const projects = async () => {
    await axios.get(`${api}/rahmaneya/projects`).then((res) => {
    setOptions(res.data);
    });
};
projects();
...
const countMasri = async () => {
    await axios.get(`${api}/rahmaneya/dues/dayone?value=${project}`).then((response) => {
...
const countYamani = async () => {
    await axios.get(`${api}/rahmaneya/dues/dayone1?value=${project}`).then((response) => {
...
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/indaytwo?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/cleardaytwo?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday3?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday3?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday4?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday4?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday5?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday5?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday6?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday6?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday7?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday7?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday8?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday8?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday9?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday9?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday10?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday10?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday11?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday11?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday12?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday12?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday13?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday13?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday14?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday14?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday15?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday15?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday16?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday16?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday17?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday17?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday18?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday18?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday19?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday19?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday20?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday20?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday21?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday21?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday22?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday22?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday23?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday23?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday24?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday24?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday25?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday25?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday26?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday26?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday27?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday27?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday28?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday28?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday29?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday29?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday30?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/rahmaneya/dues/clearday30?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/inday31?value=${project}`).then((response) => {
...
// useEffect(() => {
//     const countIndonesi = async () => {
//         await axios.get(`${api}/rahmaneya/dues/clearday31?value=${project}`).then((response) => {
...
useEffect(() => {
const countMasri = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/dayone?value=${project}`).then((response) => {
...
useEffect(() => {
const countYamani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/dayone1?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/indaytwo?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/cleardaytwo?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday3?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday3?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday4?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday4?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday5?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday5?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday6?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday6?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday7?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday7?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday8?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday8?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday9?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday9?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday10?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday10?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday11?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday11?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday12?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday12?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday13?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday13?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday14?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday14?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday15?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday15?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday16?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday16?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday17?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday17?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday18?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday18?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday19?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday19?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday20?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday20?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday21?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday21?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday22?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday22?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday23?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday23?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday24?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday24?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday25?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday25?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday26?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday26?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday27?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday27?value=${project}`)
   .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday28?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday28?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday29?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday29?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday30?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/rahmaneya/dues/food/clearday30?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/rahmaneya/dues/food/inday31?value=${project}`).then((response) => {
...
// useEffect(() => {
//     const countIndonesi = async () => {
//         await axios.get(`${api}/rahmaneya/dues/food/clearday31?value=${project}`).then((response) => {
//             if (monthDays === 30 || monthDays === 28){
...
<div className="new1">
    ...
    <div className="form" style={{ marginBottom: "10px" }}>
        <h1>
        فاتورة عمارة الرحمانية لشهر {currentMonth} - {new Date().getFullYear()}{" "}
        مشروع:{project}
        </h1>
        <Formik
    ...
    <span style={{ fontSize: "14px" }}>فاتورة عمارة الرحمانية</span>
    <div>
        <span style={{ color: "teal", fontSize: "15px", alignSelf: "end" }}>
        MONTH FROM : {firstDay} TO {lastDay}
        </span>
        <div style={{ display: "flex", justifyContent: "space-around" }}>
        <a href={`${api}/rahmaneya/invoicereport/api/file?value=${project}`}>
            <svg
        ...
        <ReactToPdf
            targetRef={ref}
            filename="فاتورة عمارة الرحمانية.pdf"
            scale={0.7}
        >
            {({ toPdf }) => (
            <svg
