...
const projects = async () => {
    await axios.get(`${api}/elsalam/projects`).then((res) => {
    setOptions(res.data);
    });
};
projects();
...
const countMasri = async () => {
    await axios.get(`${api}/elsalam/dues/dayone?value=${project}`).then((response) => {
...
const countYamani = async () => {
    await axios.get(`${api}/elsalam/dues/dayone1?value=${project}`).then((response) => {
...
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/indaytwo?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/cleardaytwo?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday3?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday3?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday4?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday4?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday5?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday5?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday6?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday6?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday7?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday7?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday8?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday8?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday9?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday9?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday10?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday10?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday11?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday11?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday12?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday12?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday13?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday13?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday14?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday14?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday15?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday15?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday16?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday16?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday17?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday17?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday18?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday18?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday19?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday19?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday20?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday20?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday21?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday21?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday22?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday22?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday23?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday23?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday24?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday24?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday25?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday25?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday26?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday26?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday27?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday27?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday28?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday28?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday29?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday29?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday30?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/elsalam/dues/clearday30?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/inday31?value=${project}`).then((response) => {
...
// useEffect(() => {
//     const countIndonesi = async () => {
//         await axios.get(`${api}/elsalam/dues/clearday31?value=${project}`).then((response) => {
...
useEffect(() => {
const countMasri = async () => {
    await axios.get(`${api}/elsalam/dues/food/dayone?value=${project}`).then((response) => {
...
useEffect(() => {
const countYamani = async () => {
    await axios.get(`${api}/elsalam/dues/food/dayone1?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/indaytwo?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/cleardaytwo?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday3?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday3?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday4?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday4?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday5?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday5?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday6?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday6?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday7?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday7?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday8?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday8?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday9?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday9?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday10?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday10?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday11?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday11?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday12?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday12?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday13?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday13?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday14?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday14?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday15?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday15?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday16?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday16?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday17?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday17?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday18?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday18?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday19?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday19?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday20?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday20?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday21?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday21?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday22?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday22?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday23?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday23?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday24?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday24?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday25?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday25?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday26?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday26?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday27?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday27?value=${project}`)
   .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday28?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday28?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday29?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday29?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday30?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/elsalam/dues/food/clearday30?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/elsalam/dues/food/inday31?value=${project}`).then((response) => {
...
// useEffect(() => {
//     const countIndonesi = async () => {
//         await axios.get(`${api}/elsalam/dues/food/clearday31?value=${project}`).then((response) => {
//             if (monthDays === 30 || monthDays === 28){
...
<div className="new1">
    ...
    <div className="form" style={{ marginBottom: "10px" }}>
        <h1>
        فاتورة عمارة السلام لشهر {currentMonth} - {new Date().getFullYear()}{" "}
        مشروع:{project}
        </h1>
        <Formik
    ...
    <span style={{ fontSize: "14px" }}>فاتورة عمارة السلام</span>
    <div>
        <span style={{ color: "teal", fontSize: "15px", alignSelf: "end" }}>
        MONTH FROM : {firstDay} TO {lastDay}
        </span>
        <div style={{ display: "flex", justifyContent: "space-around" }}>
        <a href={`${api}/elsalam/invoicereport/api/file?value=${project}`}>
            <svg
        ...
        <ReactToPdf
            targetRef={ref}
            filename="فاتورة عمارة السلام.pdf"
            scale={0.7}
        >
            {({ toPdf }) => (
            <svg
