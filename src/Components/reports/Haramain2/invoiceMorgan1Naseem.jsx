...
const projects = async () => {
    await axios.get(`${api}/morgan1naseem/projects`).then((res) => {
    setOptions(res.data);
    });
};
projects();
...
const countMasri = async () => {
    await axios.get(`${api}/morgan1naseem/dues/dayone?value=${project}`).then((response) => {
...
const countYamani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/dayone1?value=${project}`).then((response) => {
...
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/indaytwo?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/cleardaytwo?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday3?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday3?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday4?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday4?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday5?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday5?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday6?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday6?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday7?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday7?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday8?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday8?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday9?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday9?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday10?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday10?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday11?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday11?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday12?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday12?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday13?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday13?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday14?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday14?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday15?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday15?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday16?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday16?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday17?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday17?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday18?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday18?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday19?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday19?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday20?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday20?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday21?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday21?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday22?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday22?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday23?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday23?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday24?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday24?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday25?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday25?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday26?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday26?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday27?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday27?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday28?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday28?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday29?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday29?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday30?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/morgan1naseem/dues/clearday30?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/inday31?value=${project}`).then((response) => {
...
// useEffect(() => {
//     const countIndonesi = async () => {
//         await axios.get(`${api}/morgan1naseem/dues/clearday31?value=${project}`).then((response) => {
...
useEffect(() => {
const countMasri = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/dayone?value=${project}`).then((response) => {
...
useEffect(() => {
const countYamani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/dayone1?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/indaytwo?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/cleardaytwo?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday3?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday3?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday4?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday4?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday5?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday5?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday6?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday6?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday7?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday7?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday8?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday8?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday9?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday9?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday10?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday10?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday11?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday11?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday12?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday12?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday13?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday13?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday14?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday14?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday15?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday15?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday16?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday16?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday17?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday17?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday18?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday18?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday19?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday19?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday20?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday20?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday21?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday21?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday22?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday22?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday23?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday23?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday24?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday24?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday25?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday25?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday26?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday26?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday27?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday27?value=${project}`)
   .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday28?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday28?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday29?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday29?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday30?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/morgan1naseem/dues/food/clearday30?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/morgan1naseem/dues/food/inday31?value=${project}`).then((response) => {
...
// useEffect(() => {
//     const countIndonesi = async () => {
//         await axios.get(`${api}/morgan1naseem/dues/food/clearday31?value=${project}`).then((response) => {
//             if (monthDays === 30 || monthDays === 28){
...
<div className="new1">
    ...
    <div className="form" style={{ marginBottom: "10px" }}>
        <h1>
        فاتورة عمارة مرجان 1 النسيم لشهر {currentMonth} - {new Date().getFullYear()}{" "}
        مشروع:{project}
        </h1>
        <Formik
    ...
    <span style={{ fontSize: "14px" }}>فاتورة عمارة مرجان 1 النسيم</span>
    <div>
        <span style={{ color: "teal", fontSize: "15px", alignSelf: "end" }}>
        MONTH FROM : {firstDay} TO {lastDay}
        </span>
        <div style={{ display: "flex", justifyContent: "space-around" }}>
        <a href={`${api}/morgan1naseem/invoicereport/api/file?value=${project}`}>
            <svg
        ...
        <ReactToPdf
            targetRef={ref}
            filename="فاتورة عمارة مرجان 1 النسيم.pdf"
            scale={0.7}
        >
            {({ toPdf }) => (
            <svg
