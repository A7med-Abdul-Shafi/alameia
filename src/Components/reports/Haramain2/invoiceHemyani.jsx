...
const projects = async () => {
    await axios.get(`${api}/hemyani/projects`).then((res) => {
    setOptions(res.data);
    });
};
projects();
...
const countMasri = async () => {
    await axios.get(`${api}/hemyani/dues/dayone?value=${project}`).then((response) => {
...
const countYamani = async () => {
    await axios.get(`${api}/hemyani/dues/dayone1?value=${project}`).then((response) => {
...
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/indaytwo?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/cleardaytwo?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday3?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday3?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday4?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday4?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday5?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday5?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday6?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday6?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday7?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday7?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday8?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday8?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday9?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday9?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday10?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday10?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday11?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday11?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday12?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday12?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday13?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday13?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday14?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday14?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday15?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday15?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday16?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday16?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday17?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday17?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday18?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday18?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday19?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday19?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday20?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday20?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday21?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday21?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday22?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday22?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday23?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday23?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday24?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday24?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday25?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday25?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday26?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday26?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday27?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday27?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday28?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday28?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday29?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday29?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday30?value=${project}`).then((response) => {
...
useEffect(() => {
const countIndonesi = async () => {
    await axios.get(`${api}/hemyani/dues/clearday30?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/inday31?value=${project}`).then((response) => {
...
// useEffect(() => {
//     const countIndonesi = async () => {
//         await axios.get(`${api}/hemyani/dues/clearday31?value=${project}`).then((response) => {
...
useEffect(() => {
const countMasri = async () => {
    await axios.get(`${api}/hemyani/dues/food/dayone?value=${project}`).then((response) => {
...
useEffect(() => {
const countYamani = async () => {
    await axios.get(`${api}/hemyani/dues/food/dayone1?value=${project}`).then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/indaytwo?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/cleardaytwo?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday3?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday3?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday4?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday4?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday5?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday5?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday6?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday6?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday7?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday7?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday8?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday8?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday9?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday9?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday10?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday10?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday11?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday11?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday12?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday12?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday13?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday13?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday14?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday14?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday15?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday15?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday16?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday16?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday17?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday17?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday18?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday18?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday19?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday19?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday20?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday20?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday21?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday21?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday22?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday22?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday23?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday23?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday24?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday24?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday25?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday25?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday26?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday26?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday27?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday27?value=${project}`)
   .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday28?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday28?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday29?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday29?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday30?value=${project}`).then((response) => {
...
const countIndonesi = async () => {
    await axios
    .get(`${api}/hemyani/dues/food/clearday30?value=${project}`)
    .then((response) => {
...
useEffect(() => {
const countPakistani = async () => {
    await axios.get(`${api}/hemyani/dues/food/inday31?value=${project}`).then((response) => {
...
// useEffect(() => {
//     const countIndonesi = async () => {
//         await axios.get(`${api}/hemyani/dues/food/clearday31?value=${project}`).then((response) => {
//             if (monthDays === 30 || monthDays === 28){
...
<div className="new1">
    ...
    <div className="form" style={{ marginBottom: "10px" }}>
        <h1>
        فاتورة عمارة الحمياني لشهر {currentMonth} - {new Date().getFullYear()}{" "}
        مشروع:{project}
        </h1>
        <Formik
    ...
    <span style={{ fontSize: "14px" }}>فاتورة عمارة الحمياني</span>
    <div>
        <span style={{ color: "teal", fontSize: "15px", alignSelf: "end" }}>
        MONTH FROM : {firstDay} TO {lastDay}
        </span>
        <div style={{ display: "flex", justifyContent: "space-around" }}>
        <a href={`${api}/hemyani/invoicereport/api/file?value=${project}`}>
            <svg
        ...
        <ReactToPdf
            targetRef={ref}
            filename="فاتورة عمارة الحمياني.pdf"
            scale={0.7}
        >
            {({ toPdf }) => (
            <svg
