...
function TableAlamaeia() {
      ...
      formatter: (listofdatabase, value, row) => {
        return (
          <div
            ...
            onClick={() => navigate(`/dashboard/single/${value.id}`)}
          >
            <svg
  ...
  const { data, isLoading, isError, refetch } = useQuery(
    ["alameia"],
    async () => {
      return await axios.get(`${api}/alameia`).then((res) => res.data);
    }
  );
  if (isError) {
...
export default React.memo(TableAlamaeia);
