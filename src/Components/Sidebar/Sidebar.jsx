    ...
    <div className="sidebar ">
      ...
      <div className="center">
        <ul>
          ...
          <Link to="/dashboard/ewaa2" style={{ textDecoration: "none" }}>
            <li>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
          ...
          <Link to="/dashboard/buildings" style={{ textDecoration: "none" }}>
            <li>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
          ...
          <Link
            to="/dashboard/alameia/transport"
            style={{ textDecoration: "none" }}
          >
            <li>
              <svg
          ...
          <Link to="/dashboard/maintainence">
            <li>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
