...
function Groupalameia() {
  ...
  const onSubmit = async (e) => {
    ...
    await axios
      .post(`${api}/alameia/uploadfile`, formData)
      .then(() => {
        Swal.fire({
          position: "center",
          icon: "success",
  ...
  const onSubmit2 = async (e) => {
    ...
    await axios
      .post(`${api}/customer/uploadfile`, formData2)
      .then(() => {
        Swal.fire({
          position: "center",
          icon: "success",
      ...
      <div className="row">
        ...
        >
          ...
          <form encType="multipart/form-data" onSubmit={onSubmit2}>
            ...
            >
              {startLoading ? Loading() : "إضافة قاعدة بيانات العمال"}
            </button>
          </form>
          <div id="response" style={{ display: "none" }}></div>
        </div>
