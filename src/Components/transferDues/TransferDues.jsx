...
function TransferDues (props) {
    ...
    useEffect(() => {
        const projects = async () => {
            await axios.get(`${api}/${props.fetchProjects}`).then((res) => {
                setOptions(res.data);
            });
        };
        projects();
    ...
    const fetchSearchResults = async (e) => {
        ...
        setIsLoading(true);
        await axios
            .get(`${api}/${props.fetchSearch}?q=${query}`)
            .then(async (res) => {
            setData(res.data);
        })
            .catch((err) => {
    ...
    const updateResults = async (e) => {
        ...
        await axios
        .put(`${api}/${props.updateEndpoint}?id=${id}&&value=${in_date}&&date=${out_date}&&reason=${out_reason}`, item)
        .then(() => {
            setIn_date("")
            setProject("")
    ...
    const handleSubmit = async (e) => {
        ...
        await axios
        .post(`${api}/${props.transferDuesEndPoint}`, formData)
        .then((response) => {
